...
<html>
<head>
	&lt;%&ndash;<link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.4.1/css/bootstrap.min.css" integrity="sha384-Vkoo8x4CGsO3+Hhxv8T/Q5PaXtkKtu6ug5TOeNV6gBiFeWPGFN9MuhOf23Q9Ifjh" crossorigin="anonymous">
	...
	<div class="upper-container">
		<div>
			<form method="get" action='<c:url value="/basket" />'>
				<a>
					&lt;%&ndash;<input type="hidden" name="customerID" value="${customerID}">&ndash;%&gt;
									...
									<c:forEach var="product" items="${products}">
										<li>
											...
											<form method="post" action='<c:url value="/basket" />'>
												&lt;%&ndash;<button type="button" class="btn btn-primary btn-sm" style="border-radius: 25px ;border: 2px  ;border-bottom-color: dimgrey ; margin-top: 15px" value="info">Info</button>&ndash;%&gt;
